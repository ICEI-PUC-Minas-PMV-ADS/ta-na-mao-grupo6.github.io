    ...
    criaAnuncio() {
        ...
        if (anunciosServicos !== null) {
            for (let i = 0; i < anunciosServicos.length; i++) {
                ...
                const img = anunciosServicos[i].imgAnuncio;
                ...
                const textH4Titulo = `${anunciosServicos[i].tituloAnuncio}`;
                ...
                nomeAnunciante.innerText = `${anunciosServicos[i].nomeVendedor}`;
                ...
                valorAnuncio.innerText = `R$${anunciosServicos[i].valor}`;
                ...
                contatoAnunciante.innerText = `${anunciosServicos[i].contatoVendedor}`;
                ...
                descricaoAnuncio.innerText = `${anunciosServicos[i].descricaoAnuncio}`;
...
const anunciosServicos = new AnunciosServicos();